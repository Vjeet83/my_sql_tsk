...
-- exaple of user crete with ip address;
...
-- jb bob user me raha kar  password change karna ho to  alter use nahi kar sakte  balki set comand use karna h;
...
/* 
global privileges
either act  on every object in every databse or act 
on the aluster as a whole 
privilege  in this category  are stored 
within the tables mysql.user and mysql.global...............
*/


-- to cheke every type of privileges;
show privileges;


-- to give access to other user bob ;
grant select on sakila.* to 'bob';
grant select on *.* to 'bob';
...
create table  bobs_previleges_table ;
